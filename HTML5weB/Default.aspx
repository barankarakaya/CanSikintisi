<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="HTML5weB.Default" %>
    ...
    <div class="main-page-wrapper">
                ...
                <nav class="navbar float-right theme-main-menu one-page-menu">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="#service-section">Hizmetlerimiz</a></li>
                            <li><a href="#project-section">Galeri</a></li>
                            <li><a href="#team-section">Ayın Kitapları</a></li>
                            <li><a href="#skill-section">İstatistikler</a></li>
        ...
        <section id="about-us">
            <div class="container">
                <div class="theme-title">
                    <h2>HAKKIMIZDA</h2>
                    <p>Küçük Bir Web Projesi..Haftasonu Çekirdek Tadında.</p>
                </div>
                <!-- /.theme-title -->
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="single-about-content">
                            ...
                            <h5><a href="#" class="tran3s">Junior Developer</a></h5>
                            <p>Bu Projede HTML5'e Biraz Daha Bakmış Oldum.</p>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="single-service-content">
                            <div class="icon-heading tran3s">
                                ...
                                <h6><a href="#" class="tran3s">7/24 Proje Geliştirme</a></h6>
                            </div>
                            <p>Çokça Severek Yaptığım Yazılım Alanında Proje Geliştiriyorum.</p>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="single-service-content">
                            <div class="icon-heading tran3s">
                                ...
                                <h6><a href="#" class="tran3s">C#-Asp.net MVC</a></h6>
                            </div>
                            <p>
                                Dönemin İhtiyaçlarına Göre Popilitesini Kaybeden veya Popilitesi artan Programlama dilleri Arasında 
									C#'in Güzel Bir Yeri Olduğunu Düşünüyorum.
                            </p>
                        </div>
                        <!-- /.single-service-content -->
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="single-service-content">
                            <div class="icon-heading tran3s">
                                ...
                                <h6><a href="#" class="tran3s">MSSQL</a></h6>
                            </div>
                            <p>
                                Anlaşılır Arayüzü , Anlaşılır içerikleriyle MSSQL Hem kullanışlı Hemde 
									Performans Olarak Gayet iyi Bir VeriTabanı.
                            </p>
                        </div>
                        <!-- /.single-service-content -->
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="single-service-content">
                            <div class="icon-heading tran3s">
                                ...
                                <h6><a href="#" class="tran3s">HTML5</a></h6>
                            </div>
                            <p>.</p>
                        </div>
                        <!-- /.single-service-content -->
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="single-service-content">
                            <div class="icon-heading tran3s">
                                ...
                                <h6><a href="#" class="tran3s">CSS</a></h6>
                            </div>
                            <p>.</p>
                        </div>
                        <!-- /.single-service-content -->
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="single-service-content">
                            <div class="icon-heading tran3s">
                                ...
                                <h6><a href="#" class="tran3s">Java Script</a></h6>
                            </div>
                            <p>
                                C# İle Benzediği İçin Basic Olarak Öğrenmekte Zorlanmıyoruz.
									Ancak Geliştirmek Size Kalmış..
                            </p>
                        </div>
                        <!-- /.single-service-content -->
                    </div>
        ...
        <div id="project-section">
            <div class="container">
                <div class="theme-title">
                    <h2>Galeri</h2>
                    <p>Sadece Menü Olsun Diye Tuttum.</p>
                </div>
                <!-- /.theme-title -->
                ...
                <div class="project-gallery clear-fix">
                    <div class="mix grid-item photo om dmedia">
                        <div class="single-img">
                            <img src="images/Fotograflar/1.jpg" alt="Image">
                            <div class="opacity">
                                <div class="border-shape">
                                    <div>
                                        <div>
                                            <h6><a href="#">Asp.net</a></h6>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.border-shape -->
                    ...
                    <div class="mix grid-item web webd dmedia support">
                        <div class="single-img">
                            <img src="images/Fotograflar/2.jpg" alt="Image">
                            <div class="opacity">
                                <div class="border-shape">
                                    <div>
                                        <div>
            ...
            <div class="container">
                <div class="clear-fix">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="img">
                            <img src="images/home/2.jpg" alt="Image"></div>
                    </div>
                    <!-- /.col- -->
        ...
        <div id="partner-section">
            <div class="container">
                <div id="partner_logo" class="owl-carousel owl-theme">
                    <div class="item">
                        <img src="images/logo/p1.png" alt="logo"></div>
                    <div class="item">
                        <img src="images/logo/p2.png" alt="logo"></div>
                    <div class="item">
                        <img src="images/logo/p3.png" alt="logo"></div>
                    <div class="item">
                        <img src="images/logo/p4.png" alt="logo"></div>
                    <div class="item">
                        <img src="images/logo/p5.png" alt="logo"></div>
                    <div class="item">
                        <img src="images/logo/p2.png" alt="logo"></div>
                </div>
                <!-- End .partner_logo -->
                ...
                <div class="clear-fix contact-address-content">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="left-side">
                            <h2>Contact Info</h2>
                            <p>
                                There are many variations of passages of Lorem Ipsum available, but the majori have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a pas of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.
                                <br>
                                <br>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor ididunt ut labore et dolore magna aliqua.
                            </p>
